...
In this project, I used Linux commands to manage file permissions to match the appropriate level of authorization set by my organization. In the projects directory, I used ls -la to examine the existing permissions. I then modified permissions on files and directories using the chmod command.
